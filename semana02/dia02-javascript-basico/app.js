...
const numero145 = 356;
const n1 = Math.floor(numero145 /100);
const n2 = Math.floor((numero145 %100)/10);
const n3 = Math.floor(numero145 %10);

const suma3cifras = n1 + n2 + n3;
const result = Math.pow(suma3cifras, 3);
